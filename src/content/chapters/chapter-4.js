  ...
  quizzes: [
    {
      ...
      options: [
        {
          bn: "সরাসরি কোড কপি পেস্ট করে প্রজেক্ট নামানো",
          en: "Copy-paste code directly to ship projects faster",
        },
        {
          bn: "পার্সোনাল টিউটর ও ডিবাগিং অ্যাসিস্ট্যান্ট হিসেবে লজিক বুঝে শেখা",
          en: "Use it as a tutor and debug assistant to learn logic details",
        },
        {
          bn: "কোড করা সম্পূর্ণ বন্ধ করে দেওয়া",
          en: "Stop writing code entirely",
        },
        {
          bn: "এআই এর তথ্য যাচাই না করে অন্ধের মতো বিশ্বাস করা",
          en: "Believe all AI codes without any manual verification",
        },
      ],
    ...
    },
    {
      ...
      options: [
        {
          bn: "এররের পেছনের কারণ সহজ বাংলায় জিজ্ঞেস করা",
          en: "Asking for error explanations in simple terms",
        },
        {
          bn: "না বুঝে সরাসরি এআই এর জেনারেট করা সম্পূর্ণ কোড কপি-পেস্ট করা",
          en: "Blindly copy-pasting full code blocks without understanding them",
        },
        {
          bn: "কোড রিভিউর জন্য পরামর্শ চাওয়া",
          en: "Asking for code reviews and tips",
        },
    ...
    },
    {
      ...
      options: [
        ...
        {
          bn: "এরর মেসেজটি পুরো কপি করে তার মানে ও সম্ভাব্য কারণ এআই কে জিজ্ঞেস করা",
          en: "Copy the error message and ask AI for its meaning and potential triggers",
        },
        {
          bn: "এআই কে সম্পূর্ণ প্রজেক্ট আবার লিখতে বলা",
          en: "Tell AI to rewrite the entire project",
        },
        {
          bn: "কোড রিফ্রেশ করতে থাকা",
          en: "Keep refreshing the page continuously",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        ...
        {
          bn: "'জাভাস্ক্রিপ্ট array map এর প্যারামিটারগুলো সহজ বাংলায় ডায়াগ্রামসহ বুঝিয়ে বলো'",
          en: "'Explain JavaScript array map parameters in simple terms with diagrams'",
        },
    ...
    },
    {
      ...
      options: [
        {
          bn: "এআই এর অত্যন্ত দ্রুত উত্তর দেওয়ার ক্ষমতা",
          en: "AI's ability to respond extremely fast",
        },
        {
          bn: "এআই কর্তৃক আত্মবিশ্বাসের সাথে সম্পূর্ণ ভুল তথ্য বা কোড প্রদান করা",
          en: "AI confidently presenting false information or broken code as correct",
        },

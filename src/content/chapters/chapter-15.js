  ...
  quizzes: [
    {
      ...
      options: [
        {
          bn: "একটি শুধুমাত্র তারবিহীন সফটওয়্যার প্রোগ্রাম",
          en: "A software program with no hardware base",
        },
        {
          bn: "মনিটরহীন ২৪ ঘণ্টা সচল থাকা ইন্টারনেটে যুক্ত একটি শক্তিশালী কম্পিউটার",
          en: "A powerful computer with no monitor, running 24/7 connected to the internet",
        },
    ...
    },
    {
      ...
      options: [
        {
          bn: "এতে কোনো ডোমেন কানেক্ট করা যায় না",
          en: "Domains cannot be linked",
        },
        {
          bn: "কম্পিউটারের সিপিইউ-র্যাম অন্যান্য ১০০টি সাইটের সাথে ভাগাভাগি হওয়ায় সাইট স্লো হওয়ার রিস্ক থাকে",
          en: "CPU and RAM resources are shared with hundreds of sites, risking slow speeds",
        },
    ...
    },
    {
      ...
      options: [
        ...
        {
          bn: "নেমসার্ভার রেকর্ড (Nameservers / NS Records)",
          en: "Nameservers / NS Records",
        },
    ...
    },
    {
      ...
      options: [
        {
          bn: "এগুলো সম্পূর্ণ ফ্রিতে পাওয়া যায়",
          en: "They are always free of cost",
        },
        {
          bn: "ট্রাফিকের চাহিদা অনুযায়ী সিপিইউ ও র্যাম অটোমেটিক বাড়ানো বা স্কেল (Scale) করা যায়",
          en: "Compute resources can scale up dynamically in response to traffic changes",
        },
        { bn: "এতে কোনো কোড লিখতে হয় না", en: "No code writing is required" },
        {
          bn: "ইন্টারনেটের স্পিড বাড়ানো বন্ধ করা যায়",
          en: "Stop internet speeds from shifting",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {

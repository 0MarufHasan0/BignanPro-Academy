...
export const chapter32Content: Chapter = {
  id: "chapter-32",
  number: 32,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        ...
        { bn: "নোড জেএস-এ অতি সহজে রাউটিং এবং ব্যাকএন্ড এপিআই সার্ভার তৈরি করা", en: "Simplifying routing and backend API server development in Node.js" },
        { bn: "ব্রাউজারে ফন্ট চেঞ্জ করা", en: "Modifying browser fonts style sheets" },
        { bn: "সার্ভারে ইমেজ ফাইল ক্রপ করা", en: "Cropping server image assets" },
      ],

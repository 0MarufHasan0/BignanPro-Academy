...
export const chapter6Content: Chapter = {
  id: "chapter-6",
  number: 6,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        ...
        { bn: "ফেচ ➔ ডিকোড ➔ এক্সিকিউট (Fetch-Decode-Execute)", en: "Fetch ➔ Decode ➔ Execute" },
    ...
    },
    {
      ...
      options: [
        { bn: "এটি একটি স্থায়ী মেমরি যেখানে ডাটা সবসময় থাকে", en: "It is a permanent storage keeping data forever" },
        { bn: "এটি বিদ্যুৎ চলে গেলে সমস্ত ডাটা মুছে ফেলা সাময়িক মেমরি (Volatile)", en: "It is volatile temporary memory that wipes clean once power turns off" },
        { bn: "এটি এসএসডির চেয়ে ধীর গতির মেমরি", en: "It is slower than permanent SSD drives" },
        { bn: "এটি কেবল ছবি সেভ করার জন্য ব্যবহৃত হয়", en: "It is only used to store images" },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "রান্নাঘরের স্থায়ী আলমারি বা কোল্ড স্টোরেজ ফ্রিজ", en: "The permanent pantry cupboard / cold storage refrigerator" },
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "অপারেটিং সিস্টেম (OS - Operating System)", en: "Operating System (OS)" },
    ...
    },
    {
      ...
      options: [
        { bn: "কম্পিউটার কোডের বাংলা অর্থ সরাসরি বুঝতে পারে", en: "Computers understand Bangla text directly" },
        { bn: "কম্পাইলার/ইন্টারপ্রেটার কোডকে বাইনারি ১ ও ০ এর মেশিন কোডে অনুবাদ করে এবং সিপিইউ তা এক্সিকিউট করে", en: "Translation tools compile code text into binary machine code (0s and 1s), which the CPU executes" },
        { bn: "কোড সরাসরি কিবোর্ড দিয়ে স্ক্রিনে প্রসেস হয়", en: "Code runs directly inside keyboard circuits" },
        { bn: "ফাইলটি সরাসরি মনিটরে রান করে", en: "Files render on screen without processing" },
      ],
      correctAnswerIndex: 1,
      explanation: {

  ...
  quizzes: [
    {
      ...
      options: [
        {
          bn: "হতাশ হয়ে প্রজেক্টের কাজ বন্ধ করা",
          en: "Get frustrated and stop work",
        },
        {
          bn: "সিস্টেমের কোন লেয়ার বা মডিউলে ডাটা ফ্লো ব্যাহত হচ্ছে তা শান্তভাবে বিশ্লেষণ করা",
          en: "Calmly analyze which layer or module in the system is failing the data flow",
        },
        {
          bn: "সব কোড ডিলিট করে আবার লেখা শুরু করা",
          en: "Delete all files and write from scratch",
        },
        {
          bn: "এআই কে দিয়ে সরাসরি নতুন কোড জেনারেট করানো",
          en: "Directly tell AI to write new codes",
        },
      ],
    ...
    },
    {
      ...
      options: [
        {
          bn: "কোড করার আগে সিউডোকোড বা খসড়া প্ল্যান করা",
          en: "Drafting pseudocode before writing script",
        },
        {
          bn: "লজিক না ভেবে সরাসরি আইডিই তে কোড করা শুরু করা",
          en: "Starting to code directly in the IDE without any logic planning",
        },
        {
          bn: "এরর মেসেজ মনোযোগ দিয়ে রিড করা",
          en: "Reading error logs carefully",
        },
        {
          bn: "মডিউলার বা রিউজেবল কোড তৈরি করা",
          en: "Creating modular and reusable functions",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        ...
        {
          bn: "রেস্টুরেন্ট সিস্টেম (Restaurant Panel)",
          en: "Restaurant Panel",
        },
    ...
    },
    {
      ...
      options: [
        {
          bn: "সিনিয়ররা কিবোর্ডে অনেক ফাস্ট টাইপ করেন",
          en: "Seniors type much faster on keyboards",
        },
        {
          bn: "সিনিয়ররা কোড লেখার চেয়ে আর্কিটেকচারাল পরিকল্পনা ও ডিকম্পোজিশনের পেছনে বেশি সময় দেন",
          en: "Seniors invest more time in system architecture planning and decomposition before coding",
        },
        {
          bn: "জুনিয়ররা কোনো এরর মেসেজ ফিক্স করতে পারেন না",
          en: "Juniors can never fix any errors",
        },
        {
          bn: "সিনিয়ররা কোনো এআই ব্যবহার করেন না",
          en: "Seniors avoid using any AI assistants",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {

...
export const chapter25Content: Chapter = {
  id: "chapter-25",
  number: 25,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        { bn: "সার্ভারের স্থায়ী ডেটাবেজ রেকর্ড", en: "A permanent server database record" },
        { bn: "কম্পোনেন্টের নিজস্ব অভ্যন্তরীণ স্মৃতি বা পরিবর্তনশীল ডেটা স্টোরেজ", en: "A component's internal memory that can change over time" },
        { bn: "একটি ব্রাউজার কুকি ফাইল", en: "A local browser cookie storage file" },
        { bn: "সিএসএস অ্যানিমেশন লাইব্রেরি", en: "A custom CSS animation library" },
      ],
    ...
    },
    {
      ...
      options: [
        { bn: "স্টেটের শুরুর মান ডিফাইন করা", en: "Setting the initial value of the state" },
        { bn: "স্টেটের মান আপডেট করার এবং রি-রেন্ডার ট্রিগার করার স্পেশাল সেটার ফাংশন", en: "The state setter function used to update state values and schedule re-renders" },
        { bn: "ইউআই ডিলিট করার মেথড", en: "A method to delete DOM nodes" },
        { bn: "জাভাস্ক্রিপ্ট ইম্পোর্ট চেক", en: "An import statement validation utility" },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        { bn: "সম্পূর্ণ পেজ রিফ্রেশ বা রিলোড করে", en: "Reloads the entire browser page" },
        { bn: "কম্পোনেন্ট ফাংশনটি পুনরায় রান করে মেমরিতে ভার্চুয়াল ডম তুলনা করে প্রয়োজনীয় অংশ আপডেট করে", en: "Re-runs the component function to construct a new Virtual DOM and updates the real DOM based on the differences" },
        { bn: "ডাটাবেজ সম্পূর্ণ ডিলিট করে দেয়", en: "Deletes all local databases" },

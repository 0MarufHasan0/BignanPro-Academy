...
export const chapter2Content: Chapter = {
  id: "chapter-2",
  number: 2,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        { bn: "কম্পিউটার কিবোর্ড খুব দ্রুত টাইপ করা", en: "Typing keyboard characters very fast" },
        { bn: "নির্দেশনার সাহায্যে সুনির্দিষ্ট সমস্যা সমাধান করা", en: "Problem-solving using sequential instructions" },
        { bn: "সব কোডিং সিনট্যাক্স মুখস্থ করে রাখা", en: "Memorizing all programming syntaxes" },
    ...
    },
    {
      ...
      options: [
        { bn: "ভয় পেয়ে কোডিং করা বন্ধ করে দেওয়া", en: "Get scared and close the workspace" },
        { bn: "শান্ত মাথায় এরর মেসেজটি পড়ে ভুল আইসোলেট বা চিহ্নিত করার চেষ্টা করা", en: "Read the error calmly and isolate the failing component logic" },
        { bn: "পুরো কোড ডিলিট করে আবার শুরু করা", en: "Delete all files and write from scratch" },
        { bn: "না বুঝে এলোমেলোভাবে কোড এডিট করতে থাকা", en: "Edit random lines of code blindly hoping it works" },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        { bn: "কেন কোড কাজ করছে না তা নিয়ে হতাশ হন", en: "Wonder emotionally why things are not working" },
        { bn: "আমি ঠিক কী পরিবর্তন করার ফলে কোডটি ভেঙে গেল তা ট্র্যাক করেন", en: "Investigate what exact parameter or system change broke the logic flow" },
        { bn: "পুরো প্রজেক্ট বাতিল করে দেন", en: "Discard the project entirely" },
        { bn: "এআই মেন্টরকে সম্পূর্ণ সলিউশন লিখে দিতে বলেন", en: "Request AI to rewrite the entire project" },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        { bn: "'আমাকে সম্পূর্ণ প্রজেক্টের কোড লিখে দাও'", en: "'Write the entire project code for me'" },
        { bn: "'লাইন ১৫-তে কেন এই এররটি আসছে তার লজিক এবং ডিবাগিংয়ের ধাপগুলো বুঝিয়ে বলো'", en: "'Explain the logic behind this line 15 error and show me how to debug it'" },
        { bn: "'এই কোডটি কাজ করছে না, কোডটি ঠিক করো'", en: "'This code is not working, fix it'" },
        { bn: "'সবচেয়ে বড় ক্যালকুলেটরের কোড কপি করতে দাও'", en: "'Give me a calculator code to copy'" },
      ],
      correctAnswerIndex: 1,
      explanation: {

...
export const chapter30Content: Chapter = {
  id: "chapter-30",
  number: 30,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        ...
        { bn: "সব পেজের জন্য একটি কমন শেয়ার্ড ফ্রেম বা কাঠামো তৈরি করা", en: "Creating a shared layout frame that wraps all page routes within the directory" },
    ...
    },
    {
      ...
      options: [
        { bn: "মেনু বার পেজ থেকে ডিলিট করে দেওয়া", en: "Deletes the navigation bar from page views" },
        { bn: "পেজ স্ক্রল করার সময় মেনু বারটিকে স্ক্রিনের ওপরে আটকে রাখা", en: "Fixes the menu bar to the top of the viewport when scrolling" },
        { bn: "লোগো সাইজ ছোট করা", en: "Resizing logo text widths" },
        { bn: "সার্ভারে এপিআই কল স্টপ করা", en: "Halting API requests to servers" },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        { bn: "সব কার্ড ইউজার ক্লিক ছাড়াই ডিলিট হওয়া", en: "Automatically deleting cards on user scrolls" },
        { bn: "ম্যানুয়ালি হার্ডকোড না করে ডাটা অবজেক্টের অ্যারে থেকে ডাইনামিকালি ইউআই রেন্ডার করা", en: "Rendering UI elements dynamically by looping over data arrays instead of hardcoding markup" },
        { bn: "সার্ভার স্পীড কমিয়ে দেওয়া", en: "Decelerating network requests" },

  ...
  quizzes: [
    {
      ...
      options: [
        {
          bn: "গিট একটি ওয়েবসাইট এবং গিটহাব একটি কিবোর্ড শর্টকাট",
          en: "Git is a website, whereas GitHub is a keyboard shortcut",
        },
        {
          bn: "গিট হলো লোকাল কম্পিউটারের ভার্সন কন্ট্রোল ইঞ্জিন এবং গিটহাব হলো ইন্টারনেটে রেপো হোস্ট করার ক্লাউড প্ল্যাটফর্ম",
          en: "Git is the local version control software engine, whereas GitHub is the cloud platform hosting repositories online",
        },
        { bn: "কোনো পার্থক্য নেই", en: "There is no difference" },
        {
          bn: "গিটহাব দিয়ে কোড এডিট করা যায় না",
          en: "GitHub cannot host repositories files",
        },
      ],
    ...
    },
    {
      ...
      options: [
        {
          bn: "ফাইলগুলো পার্মানেন্ট ডিলিট করা",
          en: "Delete files permanently",
        },
        {
          bn: "প্রজেক্টের নির্দিষ্ট মুহূর্তের কোডের স্ন্যাপশট বা চেকপয়েন্ট স্থায়ীভাবে সেভ রাখা",
          en: "Save a snapshot checkpoint of the project workspace state permanently",
        },
        {
          bn: "সার্ভারে ফাইল আপলোড করা",
          en: "Upload files to web hosting servers",
        },
    ...
    },
    {
      ...
      options: [
        ...
        {
          bn: "Branching (ব্রাঞ্চ তৈরি করা)",
          en: "Branching (Creating a branch)",
        },

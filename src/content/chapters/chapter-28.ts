...
export const chapter28Content: Chapter = {
  id: "chapter-28",
  number: 28,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        { bn: "একটি ডেটাবেজ সফটওয়্যার সামগ্রী", en: "A relational database software utility" },
        { bn: "রিঅ্যাক্টের একটি প্রোডাকশন-গ্রেড ফুলস্ট্যাক ফ্রেমওয়ার্ক", en: "A production-grade fullstack React framework developed by Vercel" },
        { bn: "একটি নতুন সিএসএস স্টাইলিং ইঞ্জিন", en: "A custom CSS compiler engine" },
        { bn: "জাভাস্ক্রিপ্টের জন্য বিকল্প ব্রাউজার", en: "An alternative web browser client" },
      ],
    ...
    },
    {
      ...
      options: [
        { bn: "রাউটিং করার জন্য ফাইল জিপ করে ইমেইল করা", en: "Sending route files inside zip formats" },
        { bn: "ডিরেক্টরি ফোল্ডারের নামের ওপর ভিত্তি করে স্বয়ংক্রিয়ভাবে ওয়েব পেজ রাউট তৈরি হওয়া", en: "Creating web routes automatically based on filesystem directory structures" },
    ...
    },
    {
      ...
      options: [
        { bn: "ব্রাউজারে জিরো জাভাস্ক্রিপ্ট বান্ডেল পাঠানো ও সুপার ফাস্ট স্পীড", en: "Sending zero client-side JavaScript bundle sizes and maximizing speed" },
        { bn: "এস ই ও (SEO) ফ্রেন্ডলি পেজ জেনারেশন", en: "SEO-friendly pre-rendered HTML pages" },
        { bn: "ডাটাবেজ ও এপিআই কী-র সর্বোচ্চ সুরক্ষা", en: "Secure database access without token exposures" },

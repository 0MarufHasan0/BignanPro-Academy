...
export const chapter19Content: Chapter = {
  id: "chapter-19",
  number: 19,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        ...
        { bn: "এইচটিএমএল পেজের অবজেক্ট নোড ট্রি কাঠামো যা জাভাস্ক্রিপ্ট দিয়ে এডিট করা যায়", en: "An object node tree of the HTML document accessible by JavaScript" },
        { bn: "একটি ডেটাবেজ সার্ভার লিঙ্ক", en: "A remote database endpoint" },
        { bn: "কম্পিউটারের গ্রাফিক্স চিপসেট", en: "A physical graphics processor" },
      ],
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "backgroundColor (ক্যামেলকেস)", en: "backgroundColor (camelCase)" },

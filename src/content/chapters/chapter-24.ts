...
export const chapter24Content: Chapter = {
  id: "chapter-24",
  number: 24,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        { bn: "একটি ডেটাবেজ ম্যানেজমেন্ট ইঞ্জিন", en: "A relational database management system" },
        { bn: "ইউজার ইন্টারফেস (UI) তৈরির জন্য একটি জনপ্রিয় ওপেন সোর্স জাভাস্ক্রিপ্ট লাইব্রেরি", en: "An open-source JavaScript library used for building user interfaces" },
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "একটি স্বাধীন, পুনর্ব্যবহারযোগ্য ইউজার ইন্টারফেস ব্লক বা কোড ফাংশন", en: "An independent, reusable block of UI defined as a function" },
        { bn: "এইচটিএমএলের পুরো বডি ট্যাগ", en: "The entire body tag of HTML documents" },
    ...
    },
    {
      ...
      options: [
        { bn: "একটি ডাটাবেজ ক্যোয়ারী ল্যাঙ্গুয়েজ", en: "A database query syntax" },
        { bn: "জাভাস্ক্রিপ্ট ফাইলের ভেতরে সরাসরি এইচটিএমএল ট্যাগ লেখার স্পেশাল সিনট্যাক্স", en: "A syntax extension allowing HTML elements to be written directly within JavaScript code" },
    ...
    },
    {
      ...
      options: [
        { bn: "যেকোনো সময় কোডে রি-অ্যাসাইন করে চাইল্ডের ভেতর পরিবর্তন করা যায়", en: "Mutable: Can be overwritten directly inside children" },
        { bn: "রিড-অনলি বা অপরিবর্তনশীল (Immutable)", en: "Read-only and immutable" },
        { bn: "ডাটাবেজে সেভ হয়ে চিরতরে ডিলিট হয়", en: "Saves on physical drive permanently" },
        { bn: "এইচটিএমএল ফাইল ক্যাশে ক্লিয়ার করে", en: "Clears HTML document caches" },
      ],
      correctAnswerIndex: 1,
      explanation: {

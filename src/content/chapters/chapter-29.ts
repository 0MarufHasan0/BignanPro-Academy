...
export const chapter29Content: Chapter = {
  id: "chapter-29",
  number: 29,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        { bn: "সার্ভারে ফাইল আপলোড করা", en: "Uploading files to server layers" },
        { bn: "নির্দিষ্ট বিষয়ের সম্পর্কিত তথ্য একটি সুবিন্যস্ত ভিজ্যুয়াল ব্লকে সাজানো", en: "Grouping related topic information in an organized visual container block" },
        { bn: "ডাটাবেজ ক্যোয়ারী রান করানো", en: "Running database query structures" },
        { bn: "ব্রাউজার উইন্ডো রিলোড করা", en: "Reloading active browser windows" },
      ],
    ...
    },
    {
      ...
      options: [
        { bn: "transition-all duration-300 hover:-translate-y-1", en: "transition-all duration-300 hover:-translate-y-1" },
        { bn: "hover:scale-normal transition-none", en: "hover:scale-normal transition-none" },
        { bn: "animate-ping hover:blur-sm", en: "animate-ping hover:blur-sm" },
        { bn: "transition-instant border-none", en: "transition-instant border-none" },
      ],
    ...
    },
    {
      ...
      options: [
        { bn: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3", en: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3" },
        { bn: "flex flex-wrap md:flex-col lg:flex-row", en: "flex flex-wrap md:flex-col lg:flex-row" },
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "bg-white/10 backdrop-blur-md", en: "bg-white/10 backdrop-blur-md" },

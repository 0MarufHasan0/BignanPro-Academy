...
export const chapter11Content: Chapter = {
  id: "chapter-11",
  number: 11,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        { bn: "কম্পিউটারের ওএস ফাইল রিমুভ করা", en: "Delete host operating system files" },
        { bn: "সার্ভার থেকে এইচটিএমএল, সিএসএস ও জেএস রিড করে ওয়েবসাইট রেন্ডার করা", en: "Fetch HTML, CSS, and JS from servers and render websites on screen" },
        { bn: "হার্ডডিস্কের মেমরি বাড়ানো", en: "Increase hardware storage storage size" },
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "চেহারা, পোশাকের কালার, স্পেসিং ও ভিজ্যুয়াল সৌন্দর্য", en: "The clothes, colors, spacing, and visual design layout" },
        { bn: "হাত-পা নাড়ানোর মস্তিষ্ক লজিক", en: "Brain logical functions and actions" },
    ...
    },
    {
      ...
      options: [
        { bn: "একটি সোজা লাইনের মতো কোড ফাইল", en: "A flat line text structure" },
        { bn: "এইচটিএমএল ট্যাগের পারিবারিক ফ্যামিলি ট্রির মতো মেমরি রিপ্রেজেন্টেশন", en: "A hierarchical family-tree-like memory representation of HTML nodes" },
    ...
    },
    {
      ...
      options: [
        { bn: "ফাইল নেটওয়ার্ক দিয়ে আপলোড করা", en: "Upload code files over networking cables" },
        { bn: "স্ক্রিনের সাইজ মেপে প্রতিটি এলিমেন্টের সঠিক পজিশন ও সাইজ মিলিমিটার বা পিক্সেলে ক্যালকুলেট করা", en: "Calculate the exact geometry, position, and coordinates of each element relative to screen viewport size" },
        { bn: "জাভাস্ক্রিপ্ট ফাইল রান করা", en: "Execute Javascript functions" },
        { bn: "পিক্সেল পেইন্ট সম্পূর্ণ বন্ধ করা", en: "Stop painting display pixels" },
      ],
      correctAnswerIndex: 1,
      explanation: {

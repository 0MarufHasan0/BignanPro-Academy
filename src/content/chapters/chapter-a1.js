  ...
  quizzes: [
    {
      ...
      options: [
        {
          bn: "এইচটিটিপি রেসপন্স JSON ফরম্যাটে পাঠানো",
          en: "Formatting HTTP JSON response streams",
        },
        {
          bn: "ব্যবসার মূল লজিক (Business Logic), ডেটা প্রসেসিং ও কুয়েরি লজিক হ্যান্ডেল করা",
          en: "Handling core business logic, calculations, and data processing operations",
        },
        {
          bn: "সিএসএস এনিমেশন ফাইল তৈরি করা",
          en: "Generating client CSS animations sheets",
        },
        {
          bn: "সার্ভার পোর্ট বন্ধ করা",
          en: "Stopping CPU server listeners socket ports",
        },
      ],
    ...
    },
    {
      ...
      options: [
        {
          bn: "সরাসরি এক্সপ্রেস রাউট পাথ ডিক্লেয়ার করা",
          en: "Declaring URL routes endpoints directly",
        },
        {
          bn: "ক্লায়েন্টের রিকোয়েস্ট (req) গ্রহণ করা এবং রেসপন্স (res) রিটার্ন করা",
          en: "Receiving HTTP request objects (req) and returning response streams (res)",
        },
        {
          bn: "ডাটাবেজ সার্ভার রিস্টার্ট করা",
          en: "Restarting database engine instances",
        },
        {
          bn: "গিট ইগনোর ফাইল জেনারেট করা",
          en: "Generating version control gitignore strings",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        {
          bn: "এটি কোডের ভলিউম কমিয়ে দেয়",
          en: "It reduces overall codebase volumes",
        },
        {
          bn: "কোডের দায়িত্বের বিভাজন পরিষ্কার রাখতে এবং কোডকে সহজে স্কেল ও রিউজেবল করার জন্য",
          en: "To maintain Separation of Concerns, ensuring code is reusable, clean, and scaled easily",
        },
        {
          bn: "এটি করলে সার্ভার মেমরি ডিলিট হয়",
          en: "It wipes local server CPU memory slots",
        },
        {
          bn: "এটি সিএসএস ক্লাস রিমুভ করে",
          en: "It strips style classes configurations",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        {
          bn: "সার্ভার অবিলম্বে শাটডাউন করতে",
          en: "To shut down the node app listener instantly",
        },
        {
          bn: "পরবর্তী মিডলওয়্যার বা কন্ট্রোলার ফাংশনে রিকোয়েস্ট প্রসেস করতে",
          en: "To forward request execution to the next middleware or controller callback",
        },
        {
          bn: "ডাটাবেজের সমস্ত টেবিল ডিলিট করতে",
          en: "To delete all tables database records",
        },
        {
          bn: "এটি জাভাস্ক্রিপ্ট ক্যাশ রিলোড করে",
          en: "It refreshes JavaScript browser caches",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {

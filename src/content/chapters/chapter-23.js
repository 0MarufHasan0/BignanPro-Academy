  ...
  quizzes: [
    {
      ...
      options: [
        {
          bn: "সবচেয়ে বেশি ফন্ট ডাউনলোড করা",
          en: "Download multiple custom fonts files",
        },
        {
          bn: "ইউটিলিটি-ফার্স্ট (Utility-First) — আলাদা সিএসএস ফাইল না লিখে এইচটিএমএলেই ছোট প্রি-বিল্ট ক্লাস ব্যবহার করা",
          en: "Utility-First: using pre-built classes directly in HTML instead of writing custom CSS rules",
        },
        {
          bn: "ডাটাবেজ কানেকশন লক করা",
          en: "Lock database network ports connection",
        },
    ...
    },
    {
      ...
      options: [
        ...
        {
          bn: "p-4 (কারণ ৪ * ৪ পিক্সেল = ১৬ পিক্সেল)",
          en: "p-4 (since 4 * 4px = 16px)",
        },
        { bn: "m-4", en: "m-4" },
        { bn: "px-16", en: "px-16" },
      ],

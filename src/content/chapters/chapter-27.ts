...
export const chapter27Content: Chapter = {
  id: "chapter-27",
  number: 27,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        { bn: "ডাটাবেজ কানেকশন স্পীড বাড়ানো", en: "Increasing database connection speeds" },
        { bn: "কোডকে পরিষ্কার, মডিউলার, স্কেলেবল ও পুনর্ব্যবহারযোগ্য রাখা", en: "Keeping code clean, modular, scalable, and reusable" },
        { bn: "এইচটিএমএল ফাইলের সাইজ কমানো", en: "Minimizing raw HTML file sizes" },
        { bn: "ব্রাউজার কুকিজ ক্যাশে ক্লিয়ার করা", en: "Clearing browser cookies and cache files" },
      ],
    ...
    },
    {
      ...
      options: [
        { bn: "এপিআই কল পরিচালনা করা", en: "Handling network API fetching routines" },
        { bn: "প্রপস গ্রহণ করে ইউজার ইন্টারফেস প্রদর্শন করা (How things look)", en: "Receiving props and rendering the user interface (How things look)" },
        { bn: "ডাটাবেজে নতুন ইউজার সেভ করা", en: "Saving database profiles" },
        { bn: "গ্লোবাল রাউটিং ম্যানেজ করা", en: "Managing global router redirections" },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        { bn: "এর ভেতরে সরাসরি কোনো সিএসএস বা স্টাইল ফাইল থাকে না", en: "It contains no styling or CSS properties directly" },
        { bn: "এটি ডাটা ফেচিং, লজিক ও স্টেট ম্যানেজ করে (How things work)", en: "It manages state, side-effects, and data queries (How things work)" },
        { bn: "এটি প্রেজেন্টেশনাল কম্পোনেন্টকে রিটার্ন করে", en: "It returns and renders presentational components" },
    ...
    },
    {
      ...
      options: [
        { bn: "ডাটাবেজ স্ক্রিপ্ট রান করা", en: "Running database seed scripts" },
        { bn: "প্যারেন্ট থেকে অনেক চাইল্ড স্তরের মধ্য দিয়ে জোর করে প্রপস পাস করে নিচে পাঠানো", en: "Passing props down through multiple intermediate components that do not need them" },
        { bn: "বাটন ক্লিক ইভেন্ট ব্লক করা", en: "Blocking button click event handlers" },
        { bn: "সিএসএস ফাইল সাইজ কমানো", en: "Compressing stylesheet configurations" },
      ],
      correctAnswerIndex: 1,
      explanation: {

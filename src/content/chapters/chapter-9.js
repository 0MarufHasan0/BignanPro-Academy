  ...
  quizzes: [
    {
      ...
      options: [
        {
          bn: "ফোল্ডার ফাইল ধারণ করে এবং ফাইল ডেটা বা তথ্য ধারণ করে",
          en: "Folders contain files, whereas files contain raw data",
        },
        { bn: "ফাইল ফোল্ডার তৈরি করতে পারে", en: "Files can contain folders" },
        {
          bn: "ফোল্ডারে ছবি সেভ রাখা যায় না",
          en: "Folders cannot save image files",
        },
    ...
    },
    {
      ...
      options: [
        {
          bn: "ফাইল সিস্টেমের সবচেয়ে গভীরে থাকা ফাইল",
          en: "The most hidden file in the directory tree",
        },
        {
          bn: "পুরো ডিরেক্টরি কাঠামোর গোড়া বা সবার ওপরে থাকা মূল ফোল্ডার",
          en: "The very beginning node or highest folder of the directory tree",
        },
    ...
    },
    {
      ...
      options: [
        {
          bn: "বর্তমান ফোল্ডারের ভেতরে ঢোকা",
          en: "Navigate into the current folder",
        },
        {
          bn: "এক ধাপ ওপরে বা প্যারেন্ট (Parent) ফোল্ডারে যাওয়া",
          en: "Move up one level into the parent folder",
        },
        {
          bn: "ফাইলটি পার্মানেন্ট ডিলিট করা",
          en: "Delete the target file permanently",
        },
    ...
    },
    {
      ...
      options: [
        {
          bn: "ফাইলের নামের অক্ষরের ক্যাপিটালাইজেশন বা কেস-সেনসিটিভিটি (Case-sensitivity)",
          en: "File name casing/capitalization due to case-sensitivity",
        },
        { bn: "ফাইলের মেমরি সাইজ কমানো", en: "Compressing memory file size" },
        { bn: "ফাইল রিফ্রেশ করতে থাকা", en: "Refreshing files continuously" },
        {
          bn: "শুধুমাত্র ডেক্সটপে ফাইল রাখা",
          en: "Keeping all files on the desktop only",
        },
      ],
      correctAnswerIndex: 0,
      explanation: {

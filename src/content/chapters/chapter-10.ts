...
export const chapter10Content: Chapter = {
  id: "chapter-10",
  number: 10,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        { bn: "একটি তারবিহীন কাল্পনিক মেঘের জগত", en: "A virtual cloud with no physical wires" },
        { bn: "সমুদ্রের তলদেশ দিয়ে ক্যাবল ও ফাইবার অপটিক দিয়ে যুক্ত বিশ্বব্যাপী কম্পিউটারের ভৌত নেটওয়ার্ক", en: "A global physical network of computers connected via undersea fiber cables and routers" },
        { bn: "একটি ডাটাবেজ চিপ", en: "A database chip" },
        { bn: "শুধুমাত্র একটি ওয়াইফাই রাউটার", en: "Just a local Wi-Fi router" },
      ],
    ...
    },
    {
      ...
      options: [
        { bn: "ব্যবহারকারীর কিবোর্ড ইনপুট টাইপ করা", en: "Type keyboard inputs for the user" },
        { bn: "সারাদিন অন থেকে ক্লায়েন্ট ডিভাইসের ফাইল রিকোয়েস্ট প্রসেস করে ডাটা সরবরাহ করা", en: "Host databases and files, responding to client requests with data payloads" },
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "প্রেরক ও প্রাপকের সুনির্দিষ্ট আইপি অ্যাড্রেস (Sender & Receiver IP)", en: "The sender and receiver unique IP addresses" },
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "ওয়াইফাই হলো লোকাল ওয়্যারলেস সংযোগ এবং ইন্টারনেট হলো গ্লোবাল কম্পিউটারের নেটওয়ার্ক", en: "Wi-Fi is local wireless connectivity, whereas the Internet is the global network of computers" },
        { bn: "কোনো তফাৎ নেই", en: "There is no difference" },
        { bn: "ওয়াইফাই প্রসেসরের গতি বাড়ায়", en: "Wi-Fi increases CPU core speeds" },
      ],
      correctAnswerIndex: 1,
      explanation: {

  ...
  quizzes: [
    {
      ...
      options: [
        {
          bn: "Endless ভিডিও টিউটোরিয়াল দেখানো",
          en: "Show endless video tutorials",
        },
        {
          bn: "একটিভ লার্নিং মেথডোলজির মাধ্যমে নিজে কোড করতে সাহায্য করা",
          en: "Promote active learning through interactive text and exercises",
        },
        {
          bn: "সরাসরি রেডিমেড কোড কপি পেস্ট করতে দেওয়া",
          en: "Provide readymade code to copy-paste",
        },
        {
          bn: "শুধুমাত্র সার্টিফিকেট বিক্রি করা",
          en: "Just sell certificates",
        },
      ],
    ...
    },
    {
      ...
      options: [
        ...
        {
          bn: "পড়ুন ➔ বুঝুন ➔ অনুশীলন ➔ তৈরি করুন ➔ পুনরাবৃত্তি",
          en: "Read ➔ Understand ➔ Practice ➔ Build ➔ Repeat",
        },
        {
          bn: "শুধু কোড কপি করুন ➔ সার্ভারে ডেপ্লয় করুন",
          en: "Just Copy ➔ Deploy to Server",
        },
        {
          bn: "টিউটোরিয়াল দেখুন ➔ অলস সময় কাটান",
          en: "Watch Tutorial ➔ Sleep",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        {
          bn: "এআই দিয়ে সম্পূর্ণ কোড লিখিয়ে রান করা",
          en: "Ask AI to generate all codes directly",
        },
        {
          bn: "লজিক্যাল ধাপ ও এরর হ্যান্ডলিংয়ের কারণ বুঝে শেখা",
          en: "Ask AI for logical steps, concepts, and error diagnostics",
        },
        {
          bn: "এআই কে হোমওয়ার্কের সব সমাধান লিখে দিতে বলা",
          en: "Tell AI to solve assignments for you",
        },
    ...
    },
    {
      ...
      options: [
        {
          bn: "কোডিং প্র্যাকটিস না করে শুধু ভিডিও দেখা ও কপি পেস্ট করা",
          en: "Watching endless tutorials without building projects",
        },
        {
          bn: "অতিরিক্ত প্রজেক্ট সাবমিট করা",
          en: "Submitting too many projects",
        },
        { bn: "ডকুমেন্টেশন বেশি পড়া", en: "Reading too much documentation" },
        {
          bn: "এআই মেন্টরকে বেশি প্রশ্ন করা",
          en: "Asking AI too many questions",
        },
      ],
    ...
    },
    {
      ...
      options: [
        ...
        {
          bn: "অ্যাডভান্সড টাইপস্ক্রিপ্ট",
          en: "Advanced TypeScript configurations",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {

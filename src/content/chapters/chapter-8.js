  ...
  quizzes: [
    {
      ...
      options: [
        {
          bn: "কম্পিউটারের পাওয়ার ক্যাবল মেরামত করা",
          en: "Repair electrical power lines",
        },
        {
          bn: "হার্ডওয়্যার রিসোর্স ম্যানেজ করা ও ইউজার অ্যাপ চালাতে সাহায্য করা",
          en: "Manage physical hardware resources and facilitate app execution",
        },
        { bn: "ইন্টারনেটের স্পিড বাড়ানো", en: "Increase internet bandwidth" },
        {
          bn: "ইউটিউব ভিডিও প্লেলিস্ট তৈরি করা",
          en: "Assemble YouTube playlists",
        },
      ],
    ...
    },
    {
      ...
      options: [
        {
          bn: "খাবারের প্লেট সুন্দর করে ধুয়ে রাখা",
          en: "Clean the plates visually",
        },
        {
          bn: "প্রতিটি প্রসেসের জন্য র‍্যামে আলাদা মেমরি বরাদ্দ করা ও ডাটা সিকিউরিটি নিশ্চিত করা",
          en: "Allocate isolated RAM tables for each running process to prevent memory conflicts",
        },
        {
          bn: "বাবুর্চির কাজের গতি বাড়ানো",
          en: "Increase chef cooking velocity",
        },
    ...
    },
    {
      ...
      options: [
        {
          bn: "কম্পিউটার ধীর গতিতে কাজ করে",
          en: "Slow down system operations",
        },
        {
          bn: "সিপিইউ সাইকেলকে অত্যন্ত ক্ষুদ্র টাইম স্লাইসে ভাগ করে দ্রুত এক প্রসেস থেকে অন্য প্রসেসে সুইচ করে",
          en: "Split CPU cycle intervals into micro-timeslices and context-switch between processes rapidly",
        },
        {
          bn: "একটি করে সম্পূর্ণ প্রজেক্ট রান শেষ করে পরবর্তী প্রজেক্ট ওপেন করে",
          en: "Execute only one project to completion before opening the next",
        },

...
export const chapter12Content: Chapter = {
  id: "chapter-12",
  number: 12,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        { bn: "গুগল ক্রোম, ভিএস কোড ও কিবোর্ড", en: "Chrome browser, VS Code, and keyboard" },
        { bn: "ফ্রন্টএন্ড, ব্যাকএন্ড এবং ডেটাবেজ (Frontend, Backend & Database)", en: "Frontend, Backend, and Database" },
        { bn: "উইন্ডোজ, অ্যান্ড্রয়েড ও সাবমেরিন তার", en: "Windows OS, Android OS, and undersea cables" },
        { bn: "এইচটিএমএল, সিএসএস ও টাইপরাইটার", en: "HTML structure, CSS style, and typewriter" },
      ],
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "ফ্রন্টএন্ড ও ব্যাকএন্ডের মধ্যে রিকোয়েস্ট ও রেসপন্স ডাটা আদান-প্রদান করা", en: "Transmit request payloads and response packets between client and server layers" },
        { bn: "বাবুর্চির হয়ে রান্নার রেসিপি কাটা", en: "Prepare raw ingredients for chef" },
    ...
    },
    {
      ...
      options: [
        { bn: "বাটনগুলোতে সুন্দর অ্যানিমেশন লোড করা", en: "Load CSS animations to buttons" },
        { bn: "বড় আকারের ডাটা স্থায়ীভাবে স্টোর করা ও কুয়েরি অনুযায়ী দ্রুত ফাইল খুঁজে দেওয়া", en: "Archive large collections of records permanently, allowing fast query retrievals" },
        { bn: "কম্পিউটারের ওএস ফাইল রিফ্রেশ করা", en: "Refresh operating system processes" },
        { bn: "সার্ভার স্পিড কমানো", en: "Slow down internet packets transmission" },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "JSON (JavaScript Object Notation)", en: "JSON (JavaScript Object Notation)" },
    ...
    },
    {
      ...
      options: [
        { bn: "ইউজার ➔ ডাটাবেজ ➔ ওএস ➔ স্ক্রিন", en: "User ➔ Database ➔ OS ➔ Screen" },
        { bn: "বাটন ক্লিক ➔ এপিআই রিকোয়েস্ট ➔ ব্যাকএন্ড ভ্যালিডেশন ➔ ডেটাবেজ কুয়েরি ➔ রেসপন্স ➔ স্ক্রিন রেন্ডার", en: "Button click ➔ API request ➔ Backend validation ➔ DB Query ➔ Server Response ➔ Screen Render" },
        { bn: "ডাটাবেজ রিফ্রেশ ➔ বাটন ক্লিক ➔ এরর", en: "DB Refresh ➔ Button click ➔ Error" },
        { bn: "সার্ভার ডাউন ➔ কম্পাইলার রান", en: "Server down ➔ Compiler run" },
      ],
      correctAnswerIndex: 1,
      explanation: {

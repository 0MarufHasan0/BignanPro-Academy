...
export const chapter14Content: Chapter = {
  id: "chapter-14",
  number: 14,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        ...
        { bn: "মানুষের সহজে মনে রাখার জন্য জটিল সংখ্যার আইপির একটি টেক্সট নাম বা মেমোরিবল রূপ", en: "A human-readable text alias for memorizing complex numeric IP addresses" },
        { bn: "প্রসেসরের স্পিড বাড়ানো", en: "Increase hardware processing speeds" },
        { bn: "ইন্টারনেটের ক্যাবল ঠিক করা", en: "Fix underwater cabling paths" },
      ],
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "ডোমেন নামকে কম্পিউটারের বোঝার উপযোগী আইপি নম্বরে অনুবাদ করা", en: "Translate human domain names into machine-readable IP addresses" },
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "Authoritative Nameserver (অথোরিটেটিভ নেমসার্ভার)", en: "Authoritative Nameserver" },
    ...
    },
    {
      ...
      options: [
        { bn: "বাংলাদেশি কান্ট্রি-কোড টপ-লেভেল ডোমেন (ccTLD)", en: "Bangladeshi country-code Top-Level Domain (ccTLD)" },

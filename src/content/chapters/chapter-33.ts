...
export const chapter33Content: Chapter = {
  id: "chapter-33",
  number: 33,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        { bn: "ব্রাউজার পেজ স্পিড বাড়ানো", en: "Increasing browser page loading speed" },
        { bn: "অ্যাপ্লিকেশনের তথ্যসমূহ স্থায়ীভাবে ও নিরাপদে সংরক্ষণ করা", en: "Storing application data safely and permanently" },
        { bn: "এইচটিএমএল কোড জেনারেট করা", en: "Generating raw HTML code templates" },
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "NoSQL বা ডকুমেন্ট-ভিত্তিক ডেটাবেজ", en: "NoSQL / Document-oriented database" },
        { bn: "কেবল ব্রাউজার লোকালস্টোরেজ", en: "Browser LocalStorage extension" },
        { bn: "অপারেটিং সিস্টেম রেজিস্ট্রি", en: "Operating system registry key store" },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        { bn: "এটি ইউজার অ্যাকাউন্ট ডিলিট করতে সাহায্য করে", en: "It deletes user accounts automatically" },
        { bn: "এটি প্রতিটি ডকুমেন্টকে আলাদা করার ইউনিক প্রাইমারি কি বা চাবি", en: "It provides a unique primary key to distinguish each document from others" },
        { bn: "এটি ডেটাবেজের স্পিড স্লো করে দেয়", en: "It slows down database indexing" },
        { bn: "এটি ফন্টের সাইজ নির্ধারণ করে", en: "It defines paragraph font styles" },
      ],
      correctAnswerIndex: 1,
      explanation: {

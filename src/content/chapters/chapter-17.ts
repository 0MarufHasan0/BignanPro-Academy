...
export const chapter17Content: Chapter = {
  id: "chapter-17",
  number: 17,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        { bn: "প্রজেক্টের ফাইল পার্মানেন্ট ডিলিট করা", en: "Delete repository files permanently" },
        { bn: "অন্য কোনো ডেভেলপারের পাবলিক রিপোজিটরিকে হুবহু কপি করে নিজের গিটহাব অ্যাকাউন্টে কাস্টম কাজের জন্য নিয়ে আসা", en: "Copy another developer's public repository under your own account for safe customization" },
        { bn: "কোডের ফাইল সাইজ কমানো", en: "Reduce code script storage size" },
        { bn: "কম্পিউটার অফলাইনে শাটডাউন দেওয়া", en: "Shutdown computer offline" },
      ],
    ...
    },
    {
      ...
      options: [
        { bn: "ইন্টারনেট কানেকশন স্পিড দ্বিগুণ করা", en: "Double internet bandwidth speed" },
        { bn: "নিজের ফিচার ব্রাঞ্চের কোড মূল বা মেইন প্রজেক্টে মার্জ করার জন্য রক্ষণাবেক্ষণকারীর কাছে অফিসিয়াল রিকোয়েস্ট পাঠানো", en: "Formally request the repository maintainer to merge changes from your branch into main" },
        { bn: "সবাইকে মেইল করা", en: "Email all organization members" },
        { bn: "প্রজেক্টের পাসওয়ার্ড ডিলিট করা", en: "Delete database credentials" },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        { bn: "শুধুমাত্র কোডের ফন্ট সাইজ বড় করা", en: "Increase text editor font sizes only" },
        { bn: "সতীর্থদের দ্বারা প্রস্তাবিত কোডের বাগ, পারফরম্যান্স ও সিকিউরিটি ভ্যালিডেশন চেক করা", en: "Inspect code changes for potential bugs, security issues, and style conventions" },
        { bn: "সার্ভার স্পিড পরিমাপ করা", en: "Measure server speeds directly" },
        { bn: "এইচটিএমএল ফাইল রি-রাইট করা", en: "Rewrite HTML files automatically" },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        { bn: "সার্ভার কানেকশন অফ করা", en: "Turn off server instances connection" },
        { bn: "প্রতিটি পৃথক টাস্ক বা কাস্টম ফিচারের কাজ আলাদা ব্রাঞ্চে করা যাতে মূল মেইন কোডে বাগ না আসে", en: "Perform specific tasks or features on dedicated branches to avoid breaking the main code" },
        { bn: "প্রজেক্ট ফোল্ডার ডিলিট করা", en: "Delete working workspace folders" },
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "কাজ শুরুর আগে ও কাজ চলাকালীন সময়ে নিয়মিত 'git pull origin main' দিয়ে কোড সিঙ্ক রাখা", en: "Sync frequently with 'git pull origin main' to pull down recent team updates" },
        { bn: "শুধুমাত্র লোকাল হোস্টে কাজ করা", en: "Run files strictly on localhost" },
        { bn: "গিটহাব অ্যাকাউন্ট ডিঅ্যাক্টিভেট করা", en: "Deactivate GitHub accounts profile" },
      ],
      correctAnswerIndex: 1,
      explanation: {

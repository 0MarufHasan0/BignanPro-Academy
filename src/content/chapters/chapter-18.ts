...
export const chapter18Content: Chapter = {
  id: "chapter-18",
  number: 18,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        { bn: "ওয়েবসাইটের কঙ্কাল কাঠামো তৈরি করা", en: "Create skeletal webpage markup layers" },
        { bn: "ওয়েবসাইটকে ইন্টারেক্টিভ ও লজিক্যাল সিদ্ধান্ত নেওয়ার বুদ্ধিমত্তা দেওয়া", en: "supply logic and dynamic interactive behaviors to webpages" },
        { bn: "শুধুমাত্র ফন্ট কালার নীল করা", en: "Style background font colors blue only" },
        { bn: "কম্পিউটারের পাওয়ার অন করা", en: "Turn on computer motherboard hardware" },
      ],
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "মেমরিতে সাময়িকভাবে ডাটা বা তথ্য সেভ করে রাখার কন্টেইনার বা পাত্র", en: "A named memory container used to store application data values" },
        { bn: "একটি ভুল কোড লাইন", en: "An invalid lines of code" },
        { bn: "ব্রাউজার ক্লোজ করার বাটন", en: "A button used to close browsers" },
      ],
      correctAnswerIndex: 1,
      explanation: {

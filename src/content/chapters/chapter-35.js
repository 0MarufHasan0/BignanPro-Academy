  ...
  quizzes: [
    {
      ...
      options: [
        {
          bn: "সার্ভারে ফাইল আপলোড দ্রুত করা",
          en: "Speeding up file uploads to servers",
        },
        {
          bn: "ব্যবহারকারীর পরিচয় যাচাই করে সঠিক অ্যাকাউন্টের অ্যাক্সেস প্রদান করা",
          en: "Verifying user identities to grant access to correct accounts",
        },
        {
          bn: "ইউজারের মাউস ক্লিক ট্র্যাক করা",
          en: "Tracking user mouse clicks",
        },
    ...
    },
    {
      ...
      options: [
        {
          bn: "কুকি ফাইল অটোমেটিক ডিলিট হওয়া",
          en: "Automating cookie deletions",
        },
        {
          bn: "জাভাস্ক্রিপ্ট কোড থেকে কুকি রিড হওয়া ব্লক করে XSS আক্রমণ থেকে রক্ষা করা",
          en: "Blocking client-side JavaScript access to prevent token theft via XSS attacks",
        },
        {
          bn: "সার্ভারের মেমরি স্পেস খালি করা",
          en: "Clearing server RAM caches",
        },
        {
          bn: "ডাটাবেজ সার্চ স্পিড বৃদ্ধি করা",
          en: "Accelerating database indexing",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        {
          bn: "ইউজারের পাসওয়ার্ড পরিবর্তন করা",
          en: "Modifying user passwords",
        },
        {
          bn: "অ্যাক্সেস টোকেন মেয়াদোত্তীর্ণ হলে ইউজার রি-লগইন ছাড়া নতুন অ্যাক্সেস টোকেন ইস্যু করা",
          en: "Generating a new Access Token automatically when the old one expires without forcing re-logins",
        },
        {
          bn: "ডাটাবেজের স্কিমা ফাইল আপডেট করা",
          en: "Altering database schema definitions",
        },
    ...
    },
    {
      ...
      options: [
        {
          bn: "ইউজার ইন্টারফেস সম্পূর্ণ ডিলিট করা",
          en: "Deleting user interfaces entirely",
        },
        {
          bn: "নিজে জটিল সিকিউরিটি কোড না লিখে তৈরি ও প্রুভেন সিকিউরড সিস্টেম ও ও-অথ সোশ্যাল লগইন ব্যবহার করা",
          en: "Leveraging proven, pre-built security architectures and ready-to-use OAuth social logins",
        },
        {
          bn: "ডাটাবেজের রিলেশন বাদ দেওয়া",
          en: "Eliminating database relational links",
        },
        {
          bn: "ডিজাইন ফাইল জেনারেট করা",
          en: "Generating layout design assets",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {

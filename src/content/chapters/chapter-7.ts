...
export const chapter7Content: Chapter = {
  id: "chapter-7",
  number: 7,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        { bn: "ভিডিও ফাইল ডাউনলোড করে রাখা", en: "Download video files permanently" },
        { bn: "নির্দেশ ফেচ, ডিকোড ও এক্সিকিউট করে সিদ্ধান্ত নেওয়া", en: "Fetch, decode, and execute instructions to process data" },
        { bn: "মনিটরের ব্রাইটনেস বা উজ্জ্বলতা বাড়ানো", en: "Increase screen display brightness" },
    ...
    },
    {
      ...
      options: [
        { bn: "ডাটাবেজ ফাইল চিরতরে সেভ রাখা", en: "Archive database collections permanently" },
        { bn: "হাজার হাজার কোর দিয়ে সমান্তরালভাবে (Parallel) রেন্ডারিং এবং ক্যালকুলেশন সম্পন্ন করা", en: "Compute parallel calculations and visual renders using thousands of cores simultaneously" },
        { bn: "কম্পিউটারের তাপমাত্রা কমানো", en: "Reduce general hardware CPU heat" },
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "মাদারবোর্ড ও বাস লাইন (Motherboard & System Buses)", en: "Motherboard and System Buses" },
    ...
    },
    {
      ...
      options: [
        { bn: "এটি বেশি বিদ্যুৎ সাশ্রয় করে", en: "It consumes more electrical voltages" },
        { bn: "এতে কোনো ঘুরতে থাকা মেকানিক্যাল পার্টস নেই, এটি সম্পূর্ণ ফ্ল্যাশ মেমরি চিপ দিয়ে তৈরি", en: "It has no physical moving parts and is built entirely on flash memory chips" },
        { bn: "এটি দেখতে বড় আকৃতির", en: "It has a larger structural size" },
        { bn: "এটি কেবল সাউন্ড ফাইল প্রসেস করে", en: "It only processes audio file packages" },
      ],
      correctAnswerIndex: 1,
      explanation: {

  ...
  quizzes: [
    {
      ...
      options: [
        {
          bn: "শুধু ওয়েবসাইটের ডিজাইন তৈরি করা",
          en: "Only design layouts of websites",
        },
        {
          bn: "শুধু ডেটাবেজে তথ্য সেভ করা",
          en: "Only write query operations inside databases",
        },
        {
          bn: "ফ্রন্টএন্ড এবং ব্যাকএন্ড—উভয় অংশেরই কাজ করা",
          en: "Develop both client-side and server-side components",
        },
        {
          bn: "শুধুমাত্র এআই টুলস ব্যবহার করা",
          en: "Only write prompt structures in AI tools",
        },
      ],

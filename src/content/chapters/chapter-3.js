  ...
  quizzes: [
    {
      ...
      options: [
        {
          bn: "সবগুলো টিউটোরিয়াল ভিডিও মুখস্থ করা",
          en: "Memorizing all tutorial videos",
        },
        {
          bn: "এক্টিভ লার্নিং এবং নিজে কোড লিখে ছোট প্রজেক্ট তৈরি করা",
          en: "Active learning and building hands-on projects",
        },
        {
          bn: "বইয়ের সব কোড খাতায় কপি করে রাখা",
          en: "Copying all code into notebooks",
        },
        {
          bn: "শুধুমাত্র এআই দিয়ে সব কোড জেনারেট করানো",
          en: "Using AI to write everything",
        },
      ],
    ...
    },
    {
      ...
      options: [
        ...
        {
          bn: "নিজে কোড না লিখে শুধু ভিডিও কনজিউম করা এবং সাহায্য ছাড়া নিজে কোড লিখতে না পারা",
          en: "Being unable to write code without tutorial guidance",
        },
        { bn: "ইউটিউব এরর প্রদর্শন করা", en: "YouTube throwing errors" },
        {
          bn: "অতিরিক্ত প্রজেক্ট তৈরি করে ক্লান্ত হওয়া",
          en: "Getting tired of building too many projects",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        {
          bn: "সব কোড হুবহু খাতায় লিখে রাখা",
          en: "Copying all code blocks verbatim",
        },
        {
          bn: "লজিক্যাল ধাপ ও এরর হ্যান্ডলিংয়ের নিয়মগুলো নিজের ভাষায় সংক্ষেপে লেখা",
          en: "Documenting logical flows and debug summaries in your own words",
        },
        { bn: "কোনো নোট না নেওয়া", en: "Taking no notes" },
        {
          bn: "সব সিনট্যাক্স স্ক্রিনশট দিয়ে রাখা",
          en: "Screenshotting everything",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        {
          bn: "সপ্তাহে একদিন ১০ ঘণ্টা কোড করা",
          en: "Coding 10 hours once a week",
        },
        {
          bn: "প্রতিদিন নিয়মিত ১-২ ঘণ্টা মন দিয়ে কোড করা",
          en: "Coding 1-2 hours consistently every single day",
        },
        {
          bn: "শুধুমাত্র পরীক্ষার আগের দিন কোড করা",
          en: "Coding only before exams",
        },
        {
          bn: "কোনো নিয়মিত রুটিন অনুসরণ না করা",
          en: "Having no study routine",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {

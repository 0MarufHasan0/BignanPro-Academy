  ...
  quizzes: [
    {
      ...
      options: [
        {
          bn: "সবচেয়ে দ্রুত গতির সার্ভার রান করা",
          en: "Run high-speed servers engines",
        },
        {
          bn: "বিভিন্ন আকারের স্ক্রিন (মোবাইল, ট্যাবলেট ও ডেস্কটপ) অনুযায়ী ওয়েবসাইটের লেআউট স্বয়ংক্রিয়ভাবে মানিয়ে নেওয়া",
          en: "Ensure the webpage layout adapts automatically based on the device screen size",
        },
        {
          bn: "জাভাস্ক্রিপ্ট ফাইল ডিলিট করা",
          en: "Delete script assets files",
        },
        {
          bn: "ডিএনএস পোর্ট পরিবর্তন করা",
          en: "Change remote port properties",
        },
      ],
    ...
    },
    {
      ...
      options: [
        {
          bn: "প্রথমে ডেস্কটপের জন্য সম্পূর্ণ সাইট ডিজাইন করা",
          en: "Style desktop viewport layout rules first",
        },
        {
          bn: "প্রথমে মোবাইলের জন্য বেসিক সিঙ্গেল কলাম কোড লেখা এবং পরবর্তীতে মিডিয়া কোয়েরি দিয়ে বড় স্ক্রিনে কলাম যোগ করা",
          en: "Write styling rules for mobile screens first, then progressively add columns for larger viewports",
        },
        { bn: "এইচটিএমএল ফাইল না লেখা", en: "Avoid coding HTML documents" },
        {
          bn: "শুধুমাত্র জাভাস্ক্রিপ্ট রান করা",
          en: "Run scripts files exclusively",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        {
          bn: "<meta name='viewport' content='width=device-width, initial-scale=1.0'>",

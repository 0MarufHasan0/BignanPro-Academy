  ...
  quizzes: [
    {
      ...
      options: [
        {
          bn: "সার্ভারের মেমোরি রিসেট করতে",
          en: "To reset server memory blocks",
        },
        {
          bn: "একই রুমে, একই দিন ও একই সময়ে দ্বিতীয় কোনো বুকিং এন্ট্রি প্রতিরোধ করতে (ডাবল বুকিং প্রতিরোধ)",
          en: "To prevent double-booking anomalies where two users reserve the same room at the same time",
        },
        {
          bn: "সিএসএস ক্লাস অপ্টিমাইজ করতে",
          en: "To optimize stylesheet layouts",
        },
        {
          bn: "ডাটাবেজের সমস্ত ইউজার অ্যাকাউন্ট ডিলিট করতে",
          en: "To delete all user database records",
        },
      ],
    ...
    },
    {
      ...
      options: [
        {
          bn: "সার্ভারের পোর্ট নাম্বার চেঞ্জ করা",
          en: "Swapping active server ports",
        },
        {
          bn: "বুকিং ডিলিট করতে চাওয়া ইউজারের আইডি এবং ডাটাবেজে বুকিংয়ের মালিকের আইডি ম্যাচ করে দেখা",
          en: "Verifying that the deleting user ID matches the booking owner ID stored in the database document",
        },
        {
          bn: "ডাটাবেজের সব কালেকশন ডিলিট করে দেওয়া",
          en: "Deleting all database collections instantly",
        },
        {
          bn: "সিএসএস এনিমেশন রিমুভ করা",
          en: "Stripping stylesheet animation layouts",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        {
          bn: "mongoose.Schema.Types.String",
          en: "mongoose.Schema.Types.String",
        },
        {
          bn: "mongoose.Schema.Types.ObjectId",
          en: "mongoose.Schema.Types.ObjectId",
        },
        {
          bn: "mongoose.Schema.Types.Number",
          en: "mongoose.Schema.Types.Number",
        },
        {
          bn: "mongoose.Schema.Types.Boolean",
          en: "mongoose.Schema.Types.Boolean",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {

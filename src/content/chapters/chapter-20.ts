...
export const chapter20Content: Chapter = {
  id: "chapter-20",
  number: 20,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        ...
        { bn: "Hyperlink Transfer protocol Layout", en: "Hyperlink Transfer protocol Layout" },
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "ওপেনিং ট্যাগ, ভেতরের কন্টেন্ট এবং ক্লোজিং ট্যাগ (Opening tag + Content + Closing tag)", en: "Opening tag + Content + Closing tag" },
    ...
    },
    {
      ...
      options: [
        { bn: "ইউজারের জন্য বাটন বা ছবি ভিজ্যুয়ালি ডিসপ্লে করা", en: "Display visual buttons or images directly to users" },
        { bn: "মেটাডাটা, পেজ টাইটেল, সার্চ কি-ওয়ার্ড ও ফাইল লিঙ্ক স্টোর করা (অদৃশ্য ব্যাকগ্রাউন্ড ব্রেন)", en: "Store metadata properties, tab titles, meta tags, and style linkages" },
        { bn: "ডাটাবেজে ফাইল রাইট করা", en: "Write database files on drive" },
        { bn: "কম্পিউটারের ওএস রিফ্রেশ করা", en: "Refresh operating system variables" },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "সার্চ ইঞ্জিনের ক্রলার (SEO) ও রিডারদের কাছে পেজের প্রতিটি ব্লকের কাজের স্পষ্ট অর্থ বুঝিয়ে দেওয়া", en: "Provide semantic meanings to browser engines and crawlers, improving SEO indexing" },
        { bn: "জাভাস্ক্রিপ্ট কোড ছোট করা", en: "Shorten Javascript function blocks" },

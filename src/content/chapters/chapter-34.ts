...
export const chapter34Content: Chapter = {
  id: "chapter-34",
  number: 34,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        { bn: "একটি ডেটাবেজ এডিট করার সফটওয়্যার", en: "A database editor software interface" },
        { bn: "স্কিমার ওপর ভিত্তি করে তৈরি ক্লাস যা দিয়ে ডেটাবেজে CRUD অপারেশন চালানো হয়", en: "A constructor class compiled from schemas to execute CRUD database queries" },
        { bn: "এইচটিএমএল ফাইল কমপ্রেস করার মিডলওয়্যার", en: "An HTML compressor middleware" },
        { bn: "জাভাস্ক্রিপ্ট ভেরিয়েবল ক্যাশিং ইঞ্জিন", en: "A JavaScript variable caching engine" },
      ],
    ...
    },
    {
      ...
      options: [
        { bn: "ডাটাবেজে ডুপ্লিকেট ভ্যালু সেভ করা ব্লক করা (যেমন ডুপ্লিকেট ইমেইল)", en: "Blocking duplicate values from being saved in the database (e.g. duplicate email fields)" },
        { bn: "পাসওয়ার্ড হাইড করা", en: "Hashing database passwords automatically" },
        { bn: "সার্ভারের মেমরি ফ্রী করা", en: "Deallocating server RAM variables" },
    ...
    },
    {
      ...
      options: [
        { bn: "সম্পূর্ণ ডেটাবেজ শাটডাউন করতে", en: "To shut down database servers" },
        { bn: "রেসপন্সে আপডেটের আগের (পুরনো) ডাটা রিটার্ন করতে", en: "To return the original document version prior to modifications" },
        { bn: "রেসপন্সে আপডেট হওয়ার পরের (নতুন) ডাটা রিটার্ন করতে", en: "To return the modified document version containing the new updates" },
    ...
    },
    {
      ...
      options: [
        { bn: "এটি কুয়েরির স্পিড ডাবল করে দেয়", en: "It doubles database processing speeds" },
        { bn: "কুয়েরি বা কানেকশনে এরর হলে সার্ভার ক্র্যাশ করা থেকে রক্ষা করতে", en: "To prevent server runtime crashes during database query errors" },
        { bn: "এটি এক্সপ্রেস লাইব্রেরি ডিলিট করে দেয়", en: "It deletes the Express library file" },
        { bn: "এটি সিএসএস ক্লাস রিমুভ করে", en: "It strips CSS styles parameters" },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        { bn: "Product.findByIdAndDelete(id)", en: "Product.findByIdAndDelete(id)" },
        { bn: "Product.removeCollection(id)", en: "Product.removeCollection(id)" },

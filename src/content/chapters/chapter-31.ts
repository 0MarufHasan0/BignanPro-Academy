...
export const chapter31Content: Chapter = {
  id: "chapter-31",
  number: 31,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        { bn: "ওয়েবসাইটের পিছনের ব্যাকগ্রাউন্ড ছবি সেট করা", en: "Setting background images on web pages" },
        { bn: "সার্ভারে ডাটা প্রসেস, অথেন্টিকেশন ও ডাটাবেজ অপারেশন সামলানো (অদৃশ্য অংশ)", en: "Handling data processing, authentication, and database operations on the server side (invisible part)" },
        { bn: "সিএসএস ক্লাস ডিলিট করা", en: "Deleting CSS class definitions" },
        { bn: "মাউস হোভার এনিমেশন চালানো", en: "Executing mouse hover animations" },
      ],
    ...
    },
    {
      ...
      options: [
        { bn: "জাভাস্ক্রিপ্টকে ব্রাউজারের বাইরে সরাসরি কম্পিউটারে বা সার্ভারে রান করানো", en: "Executing JavaScript directly on machines or servers outside the web browser" },
        { bn: "এইচটিএমএল ফাইল কমপ্রেস করা", en: "Compressing raw HTML templates" },
        { bn: "সিএসএস গ্রিড লেআউট ডিজাইন করা", en: "Designing CSS Grid alignments" },
        { bn: "ডাটাবেজ পাসওয়ার্ড পরিবর্তন করা", en: "Altering database credentials" },
      ],
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "ফ্রন্টএন্ড এবং ব্যাকএন্ডের মধ্যে সংযোগ সেতু হিসেবে কাজ করে ডাটা আদান-প্রদান করা", en: "Acting as a communication bridge between frontend and backend to exchange data" },
        { bn: "সার্ভার অফ করে দেওয়া", en: "Shutting down the server processes" },
    ...
    },
    {
      ...
      options: [
        { bn: "এটি নোড জেএস-এর জন্য একটি হালকা ও জনপ্রিয় ব্যাকএন্ড ওয়েব ফ্রেমওয়ার্ক", en: "It is a minimalist and popular backend web framework built for Node.js" },
        { bn: "এটি একটি ডাটাবেজ কোয়েরি সফটওয়্যার", en: "It is a database query editor" },
        { bn: "এটি ইমেজ এডিটর টুলস", en: "It is an image editor tool" },
        { bn: "এটি ব্রাউজার এক্সটেনশন", en: "It is a browser extension utility" },
      ],
      correctAnswerIndex: 0,
      explanation: {

...
export const chapter13Content: Chapter = {
  id: "chapter-13",
  number: 13,
  title: {
  ...
  quizzes: [
    {
      ...
      options: [
        { bn: "কম্পিউটারের প্রসেসর কুলিং সিস্টেম", en: "A CPU cooling system manager" },
        { bn: "ব্রাউজার এবং সার্ভারের মধ্যে যোগাযোগের আন্তর্জাতিক সুনির্দিষ্ট নিয়মনীতি বা প্রোটোকল", en: "A standardized protocol governing client-server communication" },
        { bn: "ওয়াইফাই স্পিড বাড়ানোর টুল", en: "A Wi-Fi diagnostic utility" },
        { bn: "শুধুমাত্র একটি ব্রাউজার আইকন", en: "Just a browser frame label" },
      ],
    ...
    },
    {
      ...
      options: [
        ...
        { bn: "ডাটা এনক্রিপ্ট বা অপাঠ্য কোডে রূপান্তর করে মাঝপথে হ্যাকারদের ডাটা চুরির হাত থেকে বাঁচানো", en: "Encrypt data to protect payload streams from packet sniffing and theft" },
        { bn: "সার্ভার স্পিড দ্বিগুণ করা", en: "Double server response throughput" },

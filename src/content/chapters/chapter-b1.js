  ...
  quizzes: [
    {
      ...
      options: [
        {
          bn: "এটি ডাটাবেজের মেমোরি ফ্রী করে",
          en: "It clears database memory records",
        },
        {
          bn: "নিরাপত্তা নিশ্চিত করা, সিএসআরএফ প্রটেকশন এবং ফাস্ট ডেভেলপমেন্ট স্পিডের জন্য",
          en: "To guarantee security compliance, prevent CSRF, and accelerate development speed",
        },
        {
          bn: "এটি সিএসএস ক্লাস জেনারেট করে",
          en: "It generates style helper utilities",
        },
        {
          bn: "এটি সার্ভার পোর্ট রিস্টার্ট করে",
          en: "It restarts local connection ports",
        },
      ],
    ...
    },
    {
      ...
      options: [
        {
          bn: "ব্যবহারকারীকে আমাদের ডাটাবেজে প্লেইন পাসওয়ার্ড স্টোর করতে হয় না",
          en: "Users do not store raw passwords in our local database catalog",
        },
        { bn: "সব ডাটা রিমুভ করে ফেলা", en: "Deleting all database records" },
        {
          bn: "সার্ভারের সিপিইউ ফ্যান স্পিড বাড়ানো",
          en: "Scaling up server hardware limits",
        },
        {
          bn: "লোকালস্টোরেজে পাসওয়ার্ড লিখে রাখা",
          en: "Writing passwords to plain localStorage files",
        },
      ],
    ...
    },
    {
      ...
      options: [
        {
          bn: "ডাটাবেজ সার্ভার শাটডাউন থাকা",
          en: "Database server connection failure",
        },
        {
          bn: "গুগল ডেভেলপার কনসোলের কলব্যাক ইউআরএল এবং আমাদের অ্যাপের সোর্স কোডের ইউআরএল পাথ ভিন্ন হওয়া",
          en: "The callback URL registered in the Google Developer Console does not match our application URL",
        },
        {
          bn: "সিএসএস ক্লাস ডিলিট হওয়া",
          en: "Deletion of style CSS files parameters",
        },
        {
          bn: "ইউজারের ইন্টারনেট বন্ধ থাকা",
          en: "User losing internet connection midway",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {

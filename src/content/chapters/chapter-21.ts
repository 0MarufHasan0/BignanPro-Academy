...
export const chapter21Content: Chapter = {
  id: "chapter-21",
  number: 21,
  title: {
...
Solidify CSS properties knowledge before exploring media queries and mobile layouts in the next chapter.`,
  ...
  quizzes: [
    ...
    },
    {
      ...
      options: [
        { bn: "Content ➔ Margin ➔ Border ➔ Padding", en: "Content ➔ Margin ➔ Border ➔ Padding" },
        { bn: "Content ➔ Padding ➔ Border ➔ Margin", en: "Content ➔ Padding ➔ Border ➔ Margin" },
        { bn: "Border ➔ Content ➔ Margin ➔ Padding", en: "Border ➔ Content ➔ Margin ➔ Padding" },
        { bn: "Margin ➔ Border ➔ Padding ➔ Content", en: "Margin ➔ Border ➔ Padding ➔ Content" },
      ],

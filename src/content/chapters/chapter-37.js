  ...
  quizzes: [
    {
      ...
      options: [
        ...
        {
          bn: "Frontend UI, Backend API, Database, Authentication",
          en: "Frontend UI, Backend API, Database, and Authentication",
        },
        {
          bn: "Git, GitHub, Vercel, Node",
          en: "Git, GitHub, Vercel, and Node",
        },
    ...
    },
    {
      ...
      options: [
        {
          bn: "পাসওয়ার্ড সরাসরি ইউআরএল লিংকে পাঠানো",
          en: "Sending raw password strings directly in URL link parameters",
        },
        {
          bn: "অনুরোধের HTTP Authorization হেডার Bearer টোকেন ভেরিফাই করা",
          en: "Verifying a signed JWT Bearer Token in the HTTP Authorization header using server middlewares",
        },
        {
          bn: "সার্ভারের ফাইল ডিলিট করে দেওয়া",
          en: "Removing server files database collections",
        },
        {
          bn: "ডাটাবেজ পাসওয়ার্ড চেঞ্জ করা",
    ...
    },
    {
      ...
      options: [
        ...
        {
          bn: "গোপন ক্রেডেনশিয়াল যেন গিটহাবে লিক না হয় এবং সিকিউর থাকে",
          en: "To prevent exposing credentials in public Git repositories, protecting databases from hijacking",
        },
        {
          bn: "সার্ভারের র‍্যাম ফ্রি করতে",
          en: "To clear backend CPU memory leaks",
        },
        {
          bn: "ইউআই ডিজাইন পরিবর্তন করতে",
          en: "To change layout colors styles",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        {
          bn: "ডাটাবেজ কানেকশন অফ করে দেওয়া",
          en: "Closing database client sessions",
        },
        {
          bn: "ব্যাকএন্ডে cors() মিডলওয়্যার কনফিগার করে ক্লায়েন্ট ডোমেন অরিজিন অ্যালাউ করা",
          en: "Mounting the cors middleware configured to allow the client domain origin",
        },
        { bn: "এইচটিএমএল ফাইল ডিলিট করা", en: "Deleting frontend HTML files" },
        {
          bn: "আইডি ভেরিফিকেশন বাদ দেওয়া",
          en: "Bypassing JWT verification checks",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        ...
        {
          bn: "এক্সপ্রেস সার্ভার (Backend) এবং মঙ্গুজ ওআরএম (Mongoose ODM)",
          en: "Express Server (Backend) and Mongoose ODM",
        },
        {
          bn: "লোকাল স্টোরেজ এবং সেশন টোকেন",
          en: "LocalStorage files and Session tokens",
        },
        {
          bn: "Vercel হোস্টিং এবং গিটহাব রেপো",
          en: "Vercel host and GitHub repositories",
        },
      ],
      correctAnswerIndex: 1,
      explanation: {

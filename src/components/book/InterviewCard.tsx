    ...
    <div className="my-8">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-bold">
          {currentLang === "bn" ? "চাকরির ইন্টারভিউ প্রস্তুতি" : "Job Interview Preparation"}
        </h3>
      </div>
          ...
          return (
            <div
              ...
              className={`border border-border/80 rounded-xl bg-card transition-all ${
                isExpanded ? "ring-1 ring-primary/25 shadow-sm" : "hover:bg-secondary/20"
              }`}
            >
              <button
              ...
              >
                <div className="flex gap-3">
                  ...
                  <span className="font-semibold text-sm md:text-md">{localize(item.question)}</span>
                </div>
                <ChevronDown

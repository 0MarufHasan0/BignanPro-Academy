      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-bold mb-4 select-none">
            ...
            {language === "bn"
              ? "বিজ্ঞানপ্রো কোর্স বুক"
              : "BignanPro Interactive Book"}
          </span>
        ...
        {(() => {
          ...
          const renderVolumeChapters = (chapters, borderGradient) => (
            <div className="grid gap-6 md:grid-cols-2">
              {chapters.map((ch) => (
                ...
                >
                  <div
                    className={`absolute top-0 left-0 w-full h-[4px] bg-gradient-to-r ${borderGradient} opacity-0 group-hover:opacity-100 transition-opacity`}
                  />
                  <div>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-border/30 mt-auto select-none">
                    ...
                    >
                      <span>
                        {language === "bn" ? "পড়া শুরু করুন" : "Start Reading"}
                      </span>
                ...
                <div>
                  <div className="border-b border-border/30 pb-4 mb-8 flex justify-between items-end select-none">
                    ...
                    <span className="text-xs font-semibold text-muted-foreground">
                      {volume1Chapters.length}{" "}
                      {language === "bn" ? "টি অধ্যায়" : "Chapters"}
                    </span>
                  </div>
                  {renderVolumeChapters(
                    volume1Chapters,
              ...
              {volume4Chapters.length > 0 && (
                <div>
                  <div className="border-b border-border/30 pb-4 mb-8 flex justify-between items-end select-none">
                    ...
                    <span className="text-xs font-semibold text-muted-foreground">
                      {volume4Chapters.length}{" "}
                      {language === "bn" ? "টি অধ্যায়" : "Chapters"}
                    </span>
                  </div>
                  {renderVolumeChapters(
                    volume4Chapters,
                    "from-indigo-600 to-violet-650",
                  )}
                </div>
              )}
            </div>

...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      title: {
        bn: "লাইনভিত্তিক কোড বিশ্লেষণ",
        en: "Line-by-Line Code Breakdown",
      },
      description: {
          ...
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-secondary border border-border/80 text-xs font-bold select-none"
              >
                <Sparkles className="w-3.5 h-3.5 text-primary animate-pulse" />
                <span>
                  {language === "bn"
                    ? "প্রোগ্রামিংয়ের নতুন বিপ্লব"
                    : "The Future of Learning Code"}
                </span>
              </motion.div>
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto mb-16 select-none">
              <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight">
                {language === "bn"
                  ? "বিজ্ঞানপ্রো কেন অনন্য?"
                  : "Why choose BignanPro?"}
              </h2>
